...
const onWheelEvent = function(e) {
    let deltaX = e.originalEvent.deltaX !== 0 ? e.originalEvent.deltaX : e.originalEvent.deltaY
    const slick = $(this)[0].slick
    
    if (!slick.animating && !blocked && prevDeltaX * deltaX > 0 && prevSlides[slick] === slick.currentSlide) {
        return;
    }
    ...
    if (deltaX > 0 && deltaX > prevDeltaX || deltaX < 0 && deltaX < prevDeltaX || !blocked) {
        blocked = true;
        prevDeltaX = deltaX;
